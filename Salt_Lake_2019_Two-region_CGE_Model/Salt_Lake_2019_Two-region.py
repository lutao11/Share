...
from salt_lake_two.Equationlib import *
from salt_lake_two.OutputFunctions import *
import os
import pandas as pd
...
modelPath = os.path.join(os.getcwd(), 'salt_lake_two')
...
# LABOR SUPPLY
LT = ['L1W_R1', 'L2W_R1', 'L3W_R1', 'L4W_R1', 'L1W_R2', 'L2W_R2', 'L3W_R2', 'L4W_R2', 'OUT1', 'OUT2', 'OUT3', 'OUT4']
...
# FACTOR TAXES
GF = ['USSOC1_R1', 'USSOC2_R1', 'USSOC3_R1', 'USSOC4_R1', 'USSOC1_R2', 'USSOC2_R2', 'USSOC3_R2', 'USSOC4_R2', 'PROTAX']
...
SAM = pd.read_csv(os.path.join(filePath, 'Salt_Lake_SAM_2019_Two.csv'), index_col=0)

# CAPITAL COMP
BB = pd.read_csv(os.path.join(filePath, 'Salt_Lake_CAPCOM_2019_Two.csv'), index_col=0)

# MISC TABLES
miscPath = os.path.join(filePath, 'MiscFile')
JOBCR = pd.read_csv(os.path.join(miscPath, 'Salt_Lake_JOBCORE_2019_Two.csv'), index_col=0)
MISCH = pd.read_csv(os.path.join(miscPath, 'Salt_Lake_HH_2019_Two.csv'), index_col=0)
OUTCR = pd.read_csv(os.path.join(miscPath, 'Salt_Lake_OUTCR_2019_Two.csv'), index_col=0)
EMPLOY = pd.read_csv(os.path.join(miscPath, 'Salt_Lake_FACTOR_2019_Two.csv'), index_col=0)
