...
from galveston.Equationlib import *
from galveston.OutputFunctions import *
import os
import pandas as pd
...
modelPath = os.path.join(os.getcwd(), 'galveston')
filePath = os.path.join(modelPath, 'galveston_data')
...
Z = ['IAGMIN', 'IUTIL', 'ICONS', 'IMANU', 'IWHOLE', 'IRETAIL', 'ITRANS', 'IPROFSER', 'IREALE', 'IEDU', 'IHEALTH', 'IART', 'IACCO', 
     'MAGMIN', 'MUTIL', 'MCONS', 'MMANU', 'MWHOLE', 'MRETAIL', 'MTRANS', 'MPROFSER', 'MREALE', 'MEDU', 'MHEALTH', 'MART', 'MACCO', 
     ...
     'HH1WI', 'HH2WI', 'HH3WI', 'HH4WI', 'HH5WI', 'HH1BI', 'HH2BI', 'HH3BI', 'HH4BI', 'HH5BI', 'HH1HI', 'HH2HI', 'HH3HI', 'HH4HI', 'HH5HI', 
     'HH1WM', 'HH2WM', 'HH3WM', 'HH4WM', 'HH5WM', 'HH1BM', 'HH2BM', 'HH3BM', 'HH4BM', 'HH5BM', 'HH1HM', 'HH2HM', 'HH3HM', 'HH4HM', 'HH5HM', 
     'WIUSSOC1', 'WIUSSOC2', 'WIUSSOC3', 'WIUSSOC4', 'BIUSSOC1', 'BIUSSOC2', 'BIUSSOC3', 'BIUSSOC4', 'HIUSSOC1', 'HIUSSOC2', 'HIUSSOC3', 'HIUSSOC4', 
     'WMUSSOC1', 'WMUSSOC2', 'WMUSSOC3', 'WMUSSOC4', 'BMUSSOC1', 'BMUSSOC2', 'BMUSSOC3', 'BMUSSOC4', 'HMUSSOC1', 'HMUSSOC2', 'HMUSSOC3', 'HMUSSOC4', 
...
# GOVERNMENTS
G = ['WIUSSOC1', 'WIUSSOC2', 'WIUSSOC3', 'WIUSSOC4', 'BIUSSOC1', 'BIUSSOC2', 'BIUSSOC3', 'BIUSSOC4', 'HIUSSOC1', 'HIUSSOC2', 'HIUSSOC3', 'HIUSSOC4', 
     'WMUSSOC1', 'WMUSSOC2', 'WMUSSOC3', 'WMUSSOC4', 'BMUSSOC1', 'BMUSSOC2', 'BMUSSOC3', 'BMUSSOC4', 'HMUSSOC1', 'HMUSSOC2', 'HMUSSOC3', 'HMUSSOC4', 
     'PROTAX', 'TXSTX', 'COUNTYSTX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']
...
GX = ['WIUSSOC1', 'WIUSSOC2', 'WIUSSOC3', 'WIUSSOC4', 'BIUSSOC1', 'BIUSSOC2', 'BIUSSOC3', 'BIUSSOC4', 'HIUSSOC1', 'HIUSSOC2', 'HIUSSOC3', 'HIUSSOC4', 
      'WMUSSOC1', 'WMUSSOC2', 'WMUSSOC3', 'WMUSSOC4', 'BMUSSOC1', 'BMUSSOC2', 'BMUSSOC3', 'BMUSSOC4', 'HMUSSOC1', 'HMUSSOC2', 'HMUSSOC3', 'HMUSSOC4', 
      'PROTAX', 'TXSTX', 'COUNTYSTX', 'USPIT', 'OTX']

# SALES OR EXCISE TAXES
GS = ['TXSTX', 'COUNTYSTX', 'OTX']

# LOCAL TAX
GC = ['PROTAX', 'TXSTX', 'COUNTYSTX', 'OTX']

# LAND TAXES
GL = ['PROTAX']

# FACTOR TAXES
GF = ['WIUSSOC1', 'WIUSSOC2', 'WIUSSOC3', 'WIUSSOC4', 'BIUSSOC1', 'BIUSSOC2', 'BIUSSOC3', 'BIUSSOC4', 'HIUSSOC1', 'HIUSSOC2', 'HIUSSOC3', 'HIUSSOC4', 
      'WMUSSOC1', 'WMUSSOC2', 'WMUSSOC3', 'WMUSSOC4', 'BMUSSOC1', 'BMUSSOC2', 'BMUSSOC3', 'BMUSSOC4', 'HMUSSOC1', 'HMUSSOC2', 'HMUSSOC3', 'HMUSSOC4', 
      'PROTAX']
...
GFUS = ['WIUSSOC1', 'WIUSSOC2', 'WIUSSOC3', 'WIUSSOC4', 'BIUSSOC1', 'BIUSSOC2', 'BIUSSOC3', 'BIUSSOC4', 'HIUSSOC1', 'HIUSSOC2', 'HIUSSOC3', 'HIUSSOC4', 
        'WMUSSOC1', 'WMUSSOC2', 'WMUSSOC3', 'WMUSSOC4', 'BMUSSOC1', 'BMUSSOC2', 'BMUSSOC3', 'BMUSSOC4', 'HMUSSOC1', 'HMUSSOC2', 'HMUSSOC3', 'HMUSSOC4']

# EXOGNOUS TRANSFER PMT
GY = ['WIUSSOC1', 'WIUSSOC2', 'WIUSSOC3', 'WIUSSOC4', 'BIUSSOC1', 'BIUSSOC2', 'BIUSSOC3', 'BIUSSOC4', 'HIUSSOC1', 'HIUSSOC2', 'HIUSSOC3', 'HIUSSOC4', 
      'WMUSSOC1', 'WMUSSOC2', 'WMUSSOC3', 'WMUSSOC4', 'BMUSSOC1', 'BMUSSOC2', 'BMUSSOC3', 'BMUSSOC4', 'HMUSSOC1', 'HMUSSOC2', 'HMUSSOC3', 'HMUSSOC4', 
      'PROTAX', 'TXSTX', 'COUNTYSTX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']

# EXOGNOUS TRANSFER PMT
GTA = ['WIUSSOC1', 'WIUSSOC2', 'WIUSSOC3', 'WIUSSOC4', 'BIUSSOC1', 'BIUSSOC2', 'BIUSSOC3', 'BIUSSOC4', 'HIUSSOC1', 'HIUSSOC2', 'HIUSSOC3', 'HIUSSOC4', 
       'WMUSSOC1', 'WMUSSOC2', 'WMUSSOC3', 'WMUSSOC4', 'BMUSSOC1', 'BMUSSOC2', 'BMUSSOC3', 'BMUSSOC4', 'HMUSSOC1', 'HMUSSOC2', 'HMUSSOC3', 'HMUSSOC4', 
       'PROTAX', 'TXSTX', 'COUNTYSTX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']
...
H = ['HH1WI', 'HH2WI', 'HH3WI', 'HH4WI', 'HH5WI', 'HH1BI', 'HH2BI', 'HH3BI', 'HH4BI', 'HH5BI', 'HH1HI', 'HH2HI', 'HH3HI', 'HH4HI', 'HH5HI', 
     'HH1WM', 'HH2WM', 'HH3WM', 'HH4WM', 'HH5WM', 'HH1BM', 'HH2BM', 'HH3BM', 'HH4BM', 'HH5BM', 'HH1HM', 'HH2HM', 'HH3HM', 'HH4HM', 'HH5HM']
...
# I+G SECTORS
IG = ['IAGMIN', 'IUTIL', 'ICONS', 'IMANU', 'IWHOLE', 'IRETAIL', 'ITRANS', 'IPROFSER', 'IREALE', 'IEDU', 'IHEALTH', 'IART', 'IACCO', 
      'MAGMIN', 'MUTIL', 'MCONS', 'MMANU', 'MWHOLE', 'MRETAIL', 'MTRANS', 'MPROFSER', 'MREALE', 'MEDU', 'MHEALTH', 'MART', 'MACCO', 
      'HS1I', 'HS2I', 'HS3I', 'HS1M', 'HS2M', 'HS3M', 'COUNTY', 'STATE', 'FED']

# INDUSTRY SECTORS
I = ['IAGMIN', 'IUTIL', 'ICONS', 'IMANU', 'IWHOLE', 'IRETAIL', 'ITRANS', 'IPROFSER', 'IREALE', 'IEDU', 'IHEALTH', 'IART', 'IACCO', 
     'MAGMIN', 'MUTIL', 'MCONS', 'MMANU', 'MWHOLE', 'MRETAIL', 'MTRANS', 'MPROFSER', 'MREALE', 'MEDU', 'MHEALTH', 'MART', 'MACCO', 
     'HS1I', 'HS2I', 'HS3I', 'HS1M', 'HS2M', 'HS3M']
...
# PRODUCTION SECTORS
IP = ['IAGMIN', 'IUTIL', 'ICONS', 'IMANU', 'IWHOLE', 'IRETAIL', 'ITRANS', 'IPROFSER', 'IREALE', 'IEDU', 'IHEALTH', 'IART', 'IACCO', 
      'MAGMIN', 'MUTIL', 'MCONS', 'MMANU', 'MWHOLE', 'MRETAIL', 'MTRANS', 'MPROFSER', 'MREALE', 'MEDU', 'MHEALTH', 'MART', 'MACCO']
...
HSD = ['HS1I', 'HS2I', 'HS3I', 'HS1M', 'HS2M', 'HS3M']

# HOUSING SERVICES
HSSET = ['HS1I', 'HS2I', 'HS3I', 'HS1M', 'HS2M', 'HS3M']

# HOUSING SERVICES 2 & 3
HS23SET = ['HS2I', 'HS3I', 'HS2M', 'HS3M']
...
SAM = pd.read_csv(os.path.join(filePath, 'Galveston_SAM_2019.csv'), index_col=0)

# CAPITAL COMP
BB = pd.read_csv(os.path.join(filePath, 'Galveston_CAPCOM_2019.csv'), index_col=0)

# MISC TABLES
miscPath = os.path.join(filePath, 'MiscFile')
JOBCR = pd.read_csv(os.path.join(miscPath, 'Galveston_JOBCORE_2019.csv'), index_col=0)
MISCH = pd.read_csv(os.path.join(miscPath, 'Galveston_HH_2019.csv'), index_col=0)
EMPLOY = pd.read_csv(os.path.join(miscPath, 'Galveston_FACTOR_2019.csv'), index_col=0)
OUTCR = pd.read_csv(os.path.join(miscPath, 'Galveston_OUTCR_2019.csv'), index_col=0)
...
exec(open(os.path.join(modelPath, "galveston_output.py")).read())