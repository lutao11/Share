...
from salt_lake.Equationlib import *
from salt_lake.OutputFunctions import *
import os
import pandas as pd
...
modelPath = os.path.join(os.getcwd(), 'salt_lake')
filePath = os.path.join(modelPath, 'salt_lake_data')
...
# FACTORS
F = ['L1W_R1', 'L2W_R1', 'L3W_R1', 'L4W_R1', 'L1W_R2', 'L2W_R2', 'L3W_R2', 'L4W_R2', 'L1W_R3', 'L2W_R3', 'L3W_R3', 'L4W_R3',
     'L1W_R4', 'L2W_R4', 'L3W_R4', 'L4W_R4', 'L1W_R5', 'L2W_R5', 'L3W_R5', 'L4W_R5', 'L1W_R6', 'L2W_R6', 'L3W_R6', 'L4W_R6',
     'L1W_R7', 'L2W_R7', 'L3W_R7', 'L4W_R7', 'KAP']
FW1 = ['L1W_R1']
FW2 = ['L2W_R1']
FW3 = ['L3W_R1']
FW4 = ['L4W_R1']
...
# LABOR SUPPLY
LT = ['L1W_R1', 'L2W_R1', 'L3W_R1', 'L4W_R1', 'L1W_R2', 'L2W_R2', 'L3W_R2', 'L4W_R2', 'L1W_R3', 'L2W_R3', 'L3W_R3', 'L4W_R3',
      'L1W_R4', 'L2W_R4', 'L3W_R4', 'L4W_R4', 'L1W_R5', 'L2W_R5', 'L3W_R5', 'L4W_R5', 'L1W_R6', 'L2W_R6', 'L3W_R6', 'L4W_R6',
      'L1W_R7', 'L2W_R7', 'L3W_R7', 'L4W_R7', 'OUT1', 'OUT2', 'OUT3', 'OUT4']

# LABOR WORKING IN GALVESTON
L = ['L1W_R1', 'L2W_R1', 'L3W_R1', 'L4W_R1', 'L1W_R2', 'L2W_R2', 'L3W_R2', 'L4W_R2', 'L1W_R3', 'L2W_R3', 'L3W_R3', 'L4W_R3',
     'L1W_R4', 'L2W_R4', 'L3W_R4', 'L4W_R4', 'L1W_R5', 'L2W_R5', 'L3W_R5', 'L4W_R5', 'L1W_R6', 'L2W_R6', 'L3W_R6', 'L4W_R6',
     'L1W_R7', 'L2W_R7', 'L3W_R7', 'L4W_R7']
...
# GOVERNMENTS
G = ['USSOC1_R1', 'USSOC2_R1', 'USSOC3_R1', 'USSOC4_R1', 'USSOC1_R2', 'USSOC2_R2', 'USSOC3_R2', 'USSOC4_R2', 'USSOC1_R3', 'USSOC2_R3', 'USSOC3_R3', 'USSOC4_R3',
     'USSOC1_R4', 'USSOC2_R4', 'USSOC3_R4', 'USSOC4_R4', 'USSOC1_R5', 'USSOC2_R5', 'USSOC3_R5', 'USSOC4_R5', 'USSOC1_R6', 'USSOC2_R6', 'USSOC3_R6', 'USSOC4_R6',
     'USSOC1_R7', 'USSOC2_R7', 'USSOC3_R7', 'USSOC4_R7', 'PROTAX', 'UTSTX', 'COUNTYSTX', 'UTITX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']
...
GX = ['USSOC1_R1', 'USSOC2_R1', 'USSOC3_R1', 'USSOC4_R1', 'USSOC1_R2', 'USSOC2_R2', 'USSOC3_R2', 'USSOC4_R2', 'USSOC1_R3', 'USSOC2_R3', 'USSOC3_R3', 'USSOC4_R3',
      'USSOC1_R4', 'USSOC2_R4', 'USSOC3_R4', 'USSOC4_R4', 'USSOC1_R5', 'USSOC2_R5', 'USSOC3_R5', 'USSOC4_R5', 'USSOC1_R6', 'USSOC2_R6', 'USSOC3_R6', 'USSOC4_R6',
      'USSOC1_R7', 'USSOC2_R7', 'USSOC3_R7', 'USSOC4_R7', 'PROTAX', 'UTSTX', 'COUNTYSTX', 'UTITX', 'USPIT', 'OTX']
...
# FACTOR TAXES
GF = ['USSOC1_R1', 'USSOC2_R1', 'USSOC3_R1', 'USSOC4_R1', 'USSOC1_R2', 'USSOC2_R2', 'USSOC3_R2', 'USSOC4_R2', 'USSOC1_R3', 'USSOC2_R3', 'USSOC3_R3', 'USSOC4_R3',
      'USSOC1_R4', 'USSOC2_R4', 'USSOC3_R4', 'USSOC4_R4', 'USSOC1_R5', 'USSOC2_R5', 'USSOC3_R5', 'USSOC4_R5', 'USSOC1_R6', 'USSOC2_R6', 'USSOC3_R6', 'USSOC4_R6',
      'USSOC1_R7', 'USSOC2_R7', 'USSOC3_R7', 'USSOC4_R7', 'PROTAX']
...
GFUS = ['USSOC1_R1', 'USSOC2_R1', 'USSOC3_R1', 'USSOC4_R1', 'USSOC1_R2', 'USSOC2_R2', 'USSOC3_R2', 'USSOC4_R2', 'USSOC1_R3', 'USSOC2_R3', 'USSOC3_R3', 'USSOC4_R3',
        'USSOC1_R4', 'USSOC2_R4', 'USSOC3_R4', 'USSOC4_R4', 'USSOC1_R5', 'USSOC2_R5', 'USSOC3_R5', 'USSOC4_R5', 'USSOC1_R6', 'USSOC2_R6', 'USSOC3_R6', 'USSOC4_R6',
        'USSOC1_R7', 'USSOC2_R7', 'USSOC3_R7', 'USSOC4_R7']

# EXOGNOUS TRANSFER PMT
GY = ['USSOC1_R1', 'USSOC2_R1', 'USSOC3_R1', 'USSOC4_R1', 'USSOC1_R2', 'USSOC2_R2', 'USSOC3_R2', 'USSOC4_R2', 'USSOC1_R3', 'USSOC2_R3', 'USSOC3_R3', 'USSOC4_R3',
      'USSOC1_R4', 'USSOC2_R4', 'USSOC3_R4', 'USSOC4_R4', 'USSOC1_R5', 'USSOC2_R5', 'USSOC3_R5', 'USSOC4_R5', 'USSOC1_R6', 'USSOC2_R6', 'USSOC3_R6', 'USSOC4_R6',
      'USSOC1_R7', 'USSOC2_R7', 'USSOC3_R7', 'USSOC4_R7', 'PROTAX', 'UTSTX', 'COUNTYSTX', 'UTITX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']

# EXOGNOUS TRANSFER PMT
GTA = ['USSOC1_R1', 'USSOC2_R1', 'USSOC3_R1', 'USSOC4_R1', 'USSOC1_R2', 'USSOC2_R2', 'USSOC3_R2', 'USSOC4_R2', 'USSOC1_R3', 'USSOC2_R3', 'USSOC3_R3', 'USSOC4_R3',
       'USSOC1_R4', 'USSOC2_R4', 'USSOC3_R4', 'USSOC4_R4', 'USSOC1_R5', 'USSOC2_R5', 'USSOC3_R5', 'USSOC4_R5', 'USSOC1_R6', 'USSOC2_R6', 'USSOC3_R6', 'USSOC4_R6',
       'USSOC1_R7', 'USSOC2_R7', 'USSOC3_R7', 'USSOC4_R7', 'PROTAX', 'UTSTX', 'COUNTYSTX', 'UTITX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']
...
H = ['HH1_R1', 'HH2_R1', 'HH3_R1', 'HH4_R1', 'HH1_R2', 'HH2_R2', 'HH3_R2', 'HH4_R2', 'HH1_R3', 'HH2_R3', 'HH3_R3', 'HH4_R3', 'HH1_R4', 'HH2_R4', 'HH3_R4', 'HH4_R4',
     'HH1_R5', 'HH2_R5', 'HH3_R5', 'HH4_R5', 'HH1_R6', 'HH2_R6', 'HH3_R6', 'HH4_R6', 'HH1_R7', 'HH2_R7', 'HH3_R7', 'HH4_R7']

# HOUSEHOLD (INCOME i, i = 1,2,3,4)
HH1 = ['HH1_R1', 'HH1_R2', 'HH1_R3', 'HH1_R4', 'HH1_R5', 'HH1_R6', 'HH1_R7']
HH2 = ['HH2_R1', 'HH2_R2', 'HH2_R3', 'HH2_R4', 'HH2_R5', 'HH2_R6', 'HH2_R7']
HH3 = ['HH3_R1', 'HH3_R2', 'HH3_R3', 'HH3_R4', 'HH3_R5', 'HH3_R6', 'HH3_R7']
HH4 = ['HH4_R1', 'HH4_R2', 'HH4_R3', 'HH4_R4', 'HH4_R5', 'HH4_R6', 'HH4_R7']
...
IG = ['AG_MI_R1', 'UTIL_R1', 'CONS_R1', 'MANU_R1', 'COMMER_R1', 'EDU_R1', 'HEALTH_R1', 'ART_ACC_R1', 'RELIG_R1', 
      ...
      'AG_MI_R7', 'UTIL_R7', 'CONS_R7', 'MANU_R7', 'COMMER_R7', 'EDU_R7', 'HEALTH_R7', 'ART_ACC_R7', 'RELIG_R7',
      'HS1_R1', 'HS2_R1', 'HS1_R2', 'HS2_R2', 'HS1_R3', 'HS2_R3', 'HS1_R4', 'HS2_R4', 'HS1_R5', 'HS2_R5', 'HS1_R6', 'HS2_R6', 'HS1_R7', 'HS2_R7',
      'COUNTY','STATE','FED']
...
HSD = ['HS1_R1', 'HS2_R1', 'HS1_R2', 'HS2_R2', 'HS1_R3', 'HS2_R3', 'HS1_R4', 'HS2_R4', 'HS1_R5', 'HS2_R5', 'HS1_R6', 'HS2_R6', 'HS1_R7', 'HS2_R7']
...
SAM = pd.read_csv(os.path.join(filePath, 'Salt_Lake_SAM_2019.csv'), index_col=0)

# CAPITAL COMP
BB = pd.read_csv(os.path.join(filePath, 'Salt_Lake_CAPCOM_2019.csv'), index_col=0)

# MISC TABLES
miscPath = os.path.join(filePath, 'MiscFile')
JOBCR = pd.read_csv(os.path.join(miscPath, 'Salt_Lake_JOBCORE_2019.csv'), index_col=0)
MISCH = pd.read_csv(os.path.join(miscPath, 'Salt_Lake_HH_2019.csv'), index_col=0)
EMPLOY = pd.read_csv(os.path.join(miscPath, 'Salt_Lake_FACTOR_2019.csv'), index_col=0)
OUTCR = pd.read_csv(os.path.join(miscPath, 'Salt_Lake_OUTCR_2019.csv'), index_col=0)
...
TAUFF.loc['USSOC1_R3', 'L1W_R3'] = 1
TAUFF.loc['USSOC2_R3', 'L2W_R3'] = 1
TAUFF.loc['USSOC3_R3', 'L3W_R3'] = 1
TAUFF.loc['USSOC4_R3', 'L4W_R3'] = 1

TAUFF.loc['USSOC1_R4', 'L1W_R4'] = 1
TAUFF.loc['USSOC2_R4', 'L2W_R4'] = 1
TAUFF.loc['USSOC3_R4', 'L3W_R4'] = 1
TAUFF.loc['USSOC4_R4', 'L4W_R4'] = 1

TAUFF.loc['USSOC1_R5', 'L1W_R5'] = 1
TAUFF.loc['USSOC2_R5', 'L2W_R5'] = 1
TAUFF.loc['USSOC3_R5', 'L3W_R5'] = 1
TAUFF.loc['USSOC4_R5', 'L4W_R5'] = 1

TAUFF.loc['USSOC1_R6', 'L1W_R6'] = 1
TAUFF.loc['USSOC2_R6', 'L2W_R6'] = 1
TAUFF.loc['USSOC3_R6', 'L3W_R6'] = 1
TAUFF.loc['USSOC4_R6', 'L4W_R6'] = 1

TAUFF.loc['USSOC1_R7', 'L1W_R7'] = 1
TAUFF.loc['USSOC2_R7', 'L2W_R7'] = 1
TAUFF.loc['USSOC3_R7', 'L3W_R7'] = 1
TAUFF.loc['USSOC4_R7', 'L4W_R7'] = 1
...
AGFS.loc['L1W_R3', G] = SAM.loc['L1W_R3', G] + SAM.loc['USSOC1_R3', G]
AGFS.loc['L2W_R3', G] = SAM.loc['L2W_R3', G] + SAM.loc['USSOC2_R3', G]
AGFS.loc['L3W_R3', G] = SAM.loc['L3W_R3', G] + SAM.loc['USSOC3_R3', G]
AGFS.loc['L4W_R3', G] = SAM.loc['L4W_R3', G] + SAM.loc['USSOC4_R3', G]

AGFS.loc['L1W_R4', G] = SAM.loc['L1W_R4', G] + SAM.loc['USSOC1_R4', G]
AGFS.loc['L2W_R4', G] = SAM.loc['L2W_R4', G] + SAM.loc['USSOC2_R4', G]
AGFS.loc['L3W_R4', G] = SAM.loc['L3W_R4', G] + SAM.loc['USSOC3_R4', G]
AGFS.loc['L4W_R4', G] = SAM.loc['L4W_R4', G] + SAM.loc['USSOC4_R4', G]

AGFS.loc['L1W_R5', G] = SAM.loc['L1W_R5', G] + SAM.loc['USSOC1_R5', G]
AGFS.loc['L2W_R5', G] = SAM.loc['L2W_R5', G] + SAM.loc['USSOC2_R5', G]
AGFS.loc['L3W_R5', G] = SAM.loc['L3W_R5', G] + SAM.loc['USSOC3_R5', G]
AGFS.loc['L4W_R5', G] = SAM.loc['L4W_R5', G] + SAM.loc['USSOC4_R5', G]

AGFS.loc['L1W_R6', G] = SAM.loc['L1W_R6', G] + SAM.loc['USSOC1_R6', G]
AGFS.loc['L2W_R6', G] = SAM.loc['L2W_R6', G] + SAM.loc['USSOC2_R6', G]
AGFS.loc['L3W_R6', G] = SAM.loc['L3W_R6', G] + SAM.loc['USSOC3_R6', G]
AGFS.loc['L4W_R6', G] = SAM.loc['L4W_R6', G] + SAM.loc['USSOC4_R6', G]

AGFS.loc['L1W_R7', G] = SAM.loc['L1W_R7', G] + SAM.loc['USSOC1_R7', G]
AGFS.loc['L2W_R7', G] = SAM.loc['L2W_R7', G] + SAM.loc['USSOC2_R7', G]
AGFS.loc['L3W_R7', G] = SAM.loc['L3W_R7', G] + SAM.loc['USSOC3_R7', G]
AGFS.loc['L4W_R7', G] = SAM.loc['L4W_R7', G] + SAM.loc['USSOC4_R7', G]
...
#                              *  ((SUM(GI, PIT0(GI,H)* HH0(H))+ SUM(G, TAUH(G,H)*HH0(H)))/(SUM(GI, PIT(GI,H)* HH(H))+ SUM(G, TAUH(G,H)*HH(H))))**(ETAPIT(H));
  ...
  line2 = (((RA.loc(L) / ExprM(vars, m = RA0.loc[L])).sum(L)/28)/(CPI.loc(H) / ExprM(vars, m = CPI0[H]))\
           * (LSEQ1line2pre.sum(0)/((HW.loc(H1) * ExprM(vars, m = JOBCOR.loc[H1,L].sum(1))).sum(H1) + CMO.loc(CM).sum(CM) + CMI.loc(L).sum(L)))\
           + ((ExprM(vars, m = EXWGEO.loc[CM].sum(0))/RA.loc(L)).sum(0)/112)\
...
# LSEQ3(L).. CMI(L)  =E= CMI0(L)* ((( RA(L)/(SUM( H, CPI(H))/30))** ECOMI(L)));
  print('LSEQ3')
  line = ExprM(vars, m = CMI0.loc[L]) * ((RA.loc(L) / (CPI.loc(H).sum(H) / 28))**(ExprM(vars, m = ECOMI.loc[L])))
