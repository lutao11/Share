...
for i in range(iNum):
    ...
    emp = DFFD[DFFD.index.isin(['L1WA', 'L2WA', 'L3WA', 'L4WA', 'L1BA', 'L2BA', 'L3BA', 'L4BA', 'L1IA', 'L2IA', 'L3IA', 'L4IA', 
     'L1WB', 'L2WB', 'L3WB', 'L4WB', 'L1BB', 'L2BB', 'L3BB', 'L4BB', 'L1IB', 'L2IB', 'L3IB', 'L4IB'])].sum().sum()
    dsr = DDS[DDS.index.isin(['HS1A','HS2A', 'HS3A', 'HS4A', 'HS1B', 'HS2B', 'HS3B', 'HS4B'])].sum()
    dsc = DDS[DDS.index.isin(['AG_MIA', 'UTILA', 'CONSTA', 'MANUA', 'WHOLEA', 'RETAILA', 'TRANSA', 'INFOA', 'FINANCEA', 'REALEA', 'PRO_MANA', 'ADMINA', 'EDUA', 'HEALTHA', 'ARTA', 'ACCOA', 'OTHERA',
     'AG_MIB', 'UTILB', 'CONSTB', 'MANUB', 'WHOLEB', 'RETAILB', 'TRANSB', 'INFOB', 'FINANCEB', 'REALEB', 'PRO_MANB', 'ADMINB', 'EDUB', 'HEALTHB', 'ARTB', 'ACCOB', 'OTHERB'])].sum()
    hhinc = DY[DY.index.isin(['HH1WA', 'HH2WA', 'HH3WA', 'HH4WA', 'HH5WA', 'HH1BA', 'HH2BA', 'HH3BA', 'HH4BA', 'HH5BA', 'HH1IA', 'HH2IA', 'HH3IA', 'HH4IA', 'HH5IA',
     'HH1WB', 'HH2WB', 'HH3WB', 'HH4WB', 'HH5WB', 'HH1BB', 'HH2BB', 'HH3BB', 'HH4BB', 'HH5BB', 'HH1IB', 'HH2IB', 'HH3IB', 'HH4IB', 'HH5IB'])].sum()
    hhdiff = HHL-HH0
    mig = hhdiff.sum()
...
df.to_csv('Lumberton_Results.csv')