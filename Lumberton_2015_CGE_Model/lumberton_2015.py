...
from lumberton.Equationlib import *
from lumberton.OutputFunctions import *
import os
import pandas as pd
...
modelPath = os.path.join(os.getcwd(), 'lumberton')
filePath = os.path.join(modelPath, 'lumberton_data')
...
# FACTORS
F = ['L1WA', 'L2WA', 'L3WA', 'L4WA', 'L1BA', 'L2BA', 'L3BA', 'L4BA', 'L1IA', 'L2IA', 'L3IA', 'L4IA',
     'L1WB', 'L2WB', 'L3WB', 'L4WB', 'L1BB', 'L2BB', 'L3BB', 'L4BB', 'L1IB', 'L2IB', 'L3IB', 'L4IB',
     'KAP']
FW1 = ['L1WA']
FW2 = ['L2WA']
FW3 = ['L3WA']
...
# LABOR SUPPLY
LT = ['L1WA', 'L2WA', 'L3WA', 'L4WA', 'L1BA', 'L2BA', 'L3BA', 'L4BA', 'L1IA', 'L2IA', 'L3IA', 'L4IA',
      'L1WB', 'L2WB', 'L3WB', 'L4WB', 'L1BB', 'L2BB', 'L3BB', 'L4BB', 'L1IB', 'L2IB', 'L3IB', 'L4IB',
      'OUT1', 'OUT2', 'OUT3', 'OUT4']

# LABOR WORKING IN GALVESTON
L = ['L1WA', 'L2WA', 'L3WA', 'L4WA', 'L1BA', 'L2BA', 'L3BA', 'L4BA', 'L1IA', 'L2IA', 'L3IA', 'L4IA',
     'L1WB', 'L2WB', 'L3WB', 'L4WB', 'L1BB', 'L2BB', 'L3BB', 'L4BB', 'L1IB', 'L2IB', 'L3IB', 'L4IB']
...
# GOVERNMENTS
G = ['USSOC1WA', 'USSOC2WA', 'USSOC3WA', 'USSOC4WA', 'USSOC1BA', 'USSOC2BA', 'USSOC3BA', 'USSOC4BA', 'USSOC1IA', 'USSOC2IA', 'USSOC3IA', 'USSOC4IA',
     'USSOC1WB', 'USSOC2WB', 'USSOC3WB', 'USSOC4WB', 'USSOC1BB', 'USSOC2BB', 'USSOC3BB', 'USSOC4BB', 'USSOC1IB', 'USSOC2IB', 'USSOC3IB', 'USSOC4IB',
     'PROTAX', 'LOCSTX', 'NCSTX', 'COUNTYSTX', 'NCITX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']
...
GX = ['USSOC1WA', 'USSOC2WA', 'USSOC3WA', 'USSOC4WA', 'USSOC1BA', 'USSOC2BA', 'USSOC3BA', 'USSOC4BA', 'USSOC1IA', 'USSOC2IA', 'USSOC3IA', 'USSOC4IA',
      'USSOC1WB', 'USSOC2WB', 'USSOC3WB', 'USSOC4WB', 'USSOC1BB', 'USSOC2BB', 'USSOC3BB', 'USSOC4BB', 'USSOC1IB', 'USSOC2IB', 'USSOC3IB', 'USSOC4IB',
      'PROTAX', 'LOCSTX', 'NCSTX', 'COUNTYSTX', 'NCITX', 'USPIT', 'OTX']

# SALES OR EXCISE TAXES
GS = ['LOCSTX', 'NCSTX', 'COUNTYSTX', 'OTX']

# LOCAL TAX
GC = ['PROTAX', 'LOCSTX', 'COUNTYSTX', 'OTX']

# LAND TAXES
GL = ['PROTAX']

# FACTOR TAXES
GF = ['USSOC1WA', 'USSOC2WA', 'USSOC3WA', 'USSOC4WA', 'USSOC1BA', 'USSOC2BA', 'USSOC3BA', 'USSOC4BA', 'USSOC1IA', 'USSOC2IA', 'USSOC3IA', 'USSOC4IA',
      'USSOC1WB', 'USSOC2WB', 'USSOC3WB', 'USSOC4WB', 'USSOC1BB', 'USSOC2BB', 'USSOC3BB', 'USSOC4BB', 'USSOC1IB', 'USSOC2IB', 'USSOC3IB', 'USSOC4IB',
      'PROTAX']
...
GFUS = ['USSOC1WA', 'USSOC2WA', 'USSOC3WA', 'USSOC4WA', 'USSOC1BA', 'USSOC2BA', 'USSOC3BA', 'USSOC4BA', 'USSOC1IA', 'USSOC2IA', 'USSOC3IA', 'USSOC4IA',
        'USSOC1WB', 'USSOC2WB', 'USSOC3WB', 'USSOC4WB', 'USSOC1BB', 'USSOC2BB', 'USSOC3BB', 'USSOC4BB', 'USSOC1IB', 'USSOC2IB', 'USSOC3IB', 'USSOC4IB']

# EXOGNOUS TRANSFER PMT
GY = ['USSOC1WA', 'USSOC2WA', 'USSOC3WA', 'USSOC4WA', 'USSOC1BA', 'USSOC2BA', 'USSOC3BA', 'USSOC4BA', 'USSOC1IA', 'USSOC2IA', 'USSOC3IA', 'USSOC4IA',
      'USSOC1WB', 'USSOC2WB', 'USSOC3WB', 'USSOC4WB', 'USSOC1BB', 'USSOC2BB', 'USSOC3BB', 'USSOC4BB', 'USSOC1IB', 'USSOC2IB', 'USSOC3IB', 'USSOC4IB',
      'PROTAX', 'LOCSTX', 'NCSTX', 'COUNTYSTX', 'NCITX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']

# EXOGNOUS TRANSFER PMT
GTA = ['USSOC1WA', 'USSOC2WA', 'USSOC3WA', 'USSOC4WA', 'USSOC1BA', 'USSOC2BA', 'USSOC3BA', 'USSOC4BA', 'USSOC1IA', 'USSOC2IA', 'USSOC3IA', 'USSOC4IA',
      'USSOC1WB', 'USSOC2WB', 'USSOC3WB', 'USSOC4WB', 'USSOC1BB', 'USSOC2BB', 'USSOC3BB', 'USSOC4BB', 'USSOC1IB', 'USSOC2IB', 'USSOC3IB', 'USSOC4IB',
      'PROTAX', 'LOCSTX', 'NCSTX', 'COUNTYSTX', 'NCITX', 'USPIT', 'OTX', 'CYGF', 'COUNTY', 'STATE', 'FED']
...
H = ['HH1WA', 'HH2WA', 'HH3WA', 'HH4WA', 'HH5WA', 'HH1BA', 'HH2BA', 'HH3BA', 'HH4BA', 'HH5BA', 'HH1IA', 'HH2IA', 'HH3IA', 'HH4IA', 'HH5IA',
     'HH1WB', 'HH2WB', 'HH3WB', 'HH4WB', 'HH5WB', 'HH1BB', 'HH2BB', 'HH3BB', 'HH4BB', 'HH5BB', 'HH1IB', 'HH2IB', 'HH3IB', 'HH4IB', 'HH5IB']

# HOUSEHOLD (INCOME i, i = 1,2,3,4,5)
HH1 = ['HH1WA', 'HH1BA', 'HH1IA', 'HH1WB', 'HH1BB', 'HH1IB']
HH2 = ['HH2WA', 'HH2BA', 'HH2IA', 'HH2WB', 'HH2BB', 'HH2IB']
HH3 = ['HH3WA', 'HH3BA', 'HH3IA', 'HH3WB', 'HH3BB', 'HH3IB']
HH4 = ['HH4WA', 'HH4BA', 'HH4IA', 'HH4WB', 'HH4BB', 'HH4IB']
HH5 = ['HH5WA', 'HH5BA', 'HH5IA', 'HH5WB', 'HH5BB', 'HH5IB']

# I+G SECTORS
IG = ['AG_MIA', 'UTILA', 'CONSTA', 'MANUA', 'WHOLEA', 'RETAILA', 'TRANSA', 'INFOA', 'FINANCEA', 'REALEA', 'PRO_MANA', 'ADMINA', 'EDUA', 'HEALTHA', 'ARTA', 'ACCOA', 'OTHERA',
      'AG_MIB', 'UTILB', 'CONSTB', 'MANUB', 'WHOLEB', 'RETAILB', 'TRANSB', 'INFOB', 'FINANCEB', 'REALEB', 'PRO_MANB', 'ADMINB', 'EDUB', 'HEALTHB', 'ARTB', 'ACCOB', 'OTHERB',
      'HS1A', 'HS2A', 'HS3A', 'HS4A', 'HS1B', 'HS2B', 'HS3B', 'HS4B', 'COUNTY', 'STATE', 'FED']

# INDUSTRY SECTORS
I = ['AG_MIA', 'UTILA', 'CONSTA', 'MANUA', 'WHOLEA', 'RETAILA', 'TRANSA', 'INFOA', 'FINANCEA', 'REALEA', 'PRO_MANA', 'ADMINA', 'EDUA', 'HEALTHA', 'ARTA', 'ACCOA', 'OTHERA',
     'AG_MIB', 'UTILB', 'CONSTB', 'MANUB', 'WHOLEB', 'RETAILB', 'TRANSB', 'INFOB', 'FINANCEB', 'REALEB', 'PRO_MANB', 'ADMINB', 'EDUB', 'HEALTHB', 'ARTB', 'ACCOB', 'OTHERB',
     'HS1A', 'HS2A', 'HS3A', 'HS4A', 'HS1B', 'HS2B', 'HS3B', 'HS4B']

# ENDOGENOUS GOVERNMENTS
IG2 = ['COUNTY', 'STATE', 'FED']

# PRODUCTION SECTORS
IP = ['AG_MIA', 'UTILA', 'CONSTA', 'MANUA', 'WHOLEA', 'RETAILA', 'TRANSA', 'INFOA', 'FINANCEA', 'REALEA', 'PRO_MANA', 'ADMINA', 'EDUA', 'HEALTHA', 'ARTA', 'ACCOA', 'OTHERA',
      'AG_MIB', 'UTILB', 'CONSTB', 'MANUB', 'WHOLEB', 'RETAILB', 'TRANSB', 'INFOB', 'FINANCEB', 'REALEB', 'PRO_MANB', 'ADMINB', 'EDUB', 'HEALTHB', 'ARTB', 'ACCOB', 'OTHERB']
...
SAM = pd.read_csv(os.path.join(filePath, 'Lumberton_SAM_2015.csv'), index_col=0)

# CAPITAL COMP
BB = pd.read_csv(os.path.join(filePath, 'Lumberton_CAPCOM_2015.csv'), index_col=0)

# MISC TABLES
miscPath = os.path.join(filePath, 'MiscFile')
JOBCR = pd.read_csv(os.path.join(miscPath, 'Lumberton_JOBCR_2015.csv'), index_col=0)
MISCH = pd.read_csv(os.path.join(miscPath, 'Lumberton_HH_2015.csv'), index_col=0)
EMPLOY = pd.read_csv(os.path.join(miscPath, 'Lumberton_FACTOR_2015.csv'), index_col=0)
OUTCR = pd.read_csv(os.path.join(miscPath, 'Lumberton_OUTCR_2015.csv'), index_col=0)
...
IGTD.loc['CYGF', 'LOCSTX'] = 1
IGTD.loc['CYGF', 'COUNTYSTX'] = 1

IGTD.loc['CYGF', 'OTX'] = 1

IGTD.loc['STATE', 'NCSTX'] = 1
IGTD.loc['STATE', 'NCITX'] = 1

TPC.loc[H,G] = 0
TPC.loc[H,GFUS] = 1

TAUFF.loc[G,F] = 0
TAUFF.loc['USSOC1WA', 'L1WA'] = 1
TAUFF.loc['USSOC2WA', 'L2WA'] = 1
TAUFF.loc['USSOC3WA', 'L3WA'] = 1
TAUFF.loc['USSOC4WA', 'L4WA'] = 1

TAUFF.loc['USSOC1BA', 'L1BA'] = 1
TAUFF.loc['USSOC2BA', 'L2BA'] = 1
TAUFF.loc['USSOC3BA', 'L3BA'] = 1
TAUFF.loc['USSOC4BA', 'L4BA'] = 1

TAUFF.loc['USSOC1IA', 'L1IA'] = 1
TAUFF.loc['USSOC2IA', 'L2IA'] = 1
TAUFF.loc['USSOC3IA', 'L3IA'] = 1
TAUFF.loc['USSOC4IA', 'L4IA'] = 1

TAUFF.loc['USSOC1WB', 'L1WB'] = 1
TAUFF.loc['USSOC2WB', 'L2WB'] = 1
TAUFF.loc['USSOC3WB', 'L3WB'] = 1
TAUFF.loc['USSOC4WB', 'L4WB'] = 1

TAUFF.loc['USSOC1BB', 'L1BB'] = 1
TAUFF.loc['USSOC2BB', 'L2BB'] = 1
TAUFF.loc['USSOC3BB', 'L3BB'] = 1
TAUFF.loc['USSOC4BB', 'L4BB'] = 1

TAUFF.loc['USSOC1IB', 'L1IB'] = 1
TAUFF.loc['USSOC2IB', 'L2IB'] = 1
TAUFF.loc['USSOC3IB', 'L3IB'] = 1
TAUFF.loc['USSOC4IB', 'L4IB'] = 1
...
AGFS.loc['L1WA', G] = SAM.loc['L1WA', G] + SAM.loc['USSOC1WA', G]
AGFS.loc['L2WA', G] = SAM.loc['L2WA', G] + SAM.loc['USSOC2WA', G]
AGFS.loc['L3WA', G] = SAM.loc['L3WA', G] + SAM.loc['USSOC3WA', G]
AGFS.loc['L4WA', G] = SAM.loc['L4WA', G] + SAM.loc['USSOC4WA', G]
AGFS.loc['L1BA', G] = SAM.loc['L1BA', G] + SAM.loc['USSOC1BA', G]
AGFS.loc['L2BA', G] = SAM.loc['L2BA', G] + SAM.loc['USSOC2BA', G]
AGFS.loc['L3BA', G] = SAM.loc['L3BA', G] + SAM.loc['USSOC3BA', G]
AGFS.loc['L4BA', G] = SAM.loc['L4BA', G] + SAM.loc['USSOC4BA', G]
AGFS.loc['L1IA', G] = SAM.loc['L1IA', G] + SAM.loc['USSOC1IA', G]
AGFS.loc['L2IA', G] = SAM.loc['L2IA', G] + SAM.loc['USSOC2IA', G]
AGFS.loc['L3IA', G] = SAM.loc['L3IA', G] + SAM.loc['USSOC3IA', G]
AGFS.loc['L4IA', G] = SAM.loc['L4IA', G] + SAM.loc['USSOC4IA', G]

AGFS.loc['L1WB', G] = SAM.loc['L1WB', G] + SAM.loc['USSOC1WB', G]
AGFS.loc['L2WB', G] = SAM.loc['L2WB', G] + SAM.loc['USSOC2WB', G]
AGFS.loc['L3WB', G] = SAM.loc['L3WB', G] + SAM.loc['USSOC3WB', G]
AGFS.loc['L4WB', G] = SAM.loc['L4WB', G] + SAM.loc['USSOC4WB', G]
AGFS.loc['L1BB', G] = SAM.loc['L1BB', G] + SAM.loc['USSOC1BB', G]
AGFS.loc['L2BB', G] = SAM.loc['L2BB', G] + SAM.loc['USSOC2BB', G]
AGFS.loc['L3BB', G] = SAM.loc['L3BB', G] + SAM.loc['USSOC3BB', G]
AGFS.loc['L4BB', G] = SAM.loc['L4BB', G] + SAM.loc['USSOC4BB', G]
AGFS.loc['L1IB', G] = SAM.loc['L1IB', G] + SAM.loc['USSOC1IB', G]
AGFS.loc['L2IB', G] = SAM.loc['L2IB', G] + SAM.loc['USSOC2IB', G]
AGFS.loc['L3IB', G] = SAM.loc['L3IB', G] + SAM.loc['USSOC3IB', G]
AGFS.loc['L4IB', G] = SAM.loc['L4IB', G] + SAM.loc['USSOC4IB', G]
...
TESTA1.loc[F, I] = R0.loc[F, I].mul(RA0.loc[F], axis='index') * (1 + TAUFX_SUM.loc[F,I]) * (FD0.loc[F, I] ** (1 - RHO.loc[I]))

# TESTA2(F,I)      = SUM(F1, R0(F1,I) * RA0(F1) * (1 + SUM(GF,TAUFX(GF,F1,I)))*((FD0(F1,I))**(1-RHO(I))));
TESTA2_pre = ( R0.loc[F, I].mul(RA0.loc[F], axis='index') * (1 + TAUFX_SUM.loc[F,I]) * (FD0.loc[F, I] ** (1 - RHO.loc[I])) ).sum(0)
TESTA2.loc[F, I] = 1
...
A.loc[H, L] = SAM.loc[H, L].div(HW0.loc[H], axis='index') / (Y0.loc[L] + SAM.loc[L, ["ROW"]].sum(1)) * (1.0 - TAUFL.loc[G, L].sum(0))

A.loc[H, K] = SAM.loc[H, K].div(HW0.loc[H], axis='index') / (Y0.loc[K] + SAM.loc[Z, K].sum(0) - SAM.loc[K, IG].sum(1))
...
CMI0.loc[['L4']] = FD0.loc[['L4'], IG].sum(1) - JOBCOR.loc[H, ['L4']].mul(HW0.loc[H], axis = 'index').sum(0)
'''
...
#               =E= PVA(I)* ALPHA(F,I)*(GAMMA(I)**RHO(I))*(DS(I)**(1-RHO(I)));
  ...
  right = ~(PVA.loc(I) * (ExprM(vars, m = ALPHA.loc[F, I] * (GAMMA.loc[I] ** RHO.loc[I])) * (DS.loc(I) ** ExprM(vars, m = 1 - RHO.loc[I]))))
  FDEQ = (right - left)
...
#                  /(PW0(I)*(1+SUM(GS,TAUQ(GS,I))))) **(ETAE(I));
  print('XEQ(I)')
  line = ExprM(vars, m = CX0.loc[I]) * ((PD.loc(I) * ExprM(vars, m = 1 + TAUX.loc[GS, I].sum(0)))/ExprM(vars, m = PW0.loc[I] * (1 + TAUQ.loc[GS, I].sum(0))))** ExprM(vars, m = ETAE.loc[I])
...
#  DEQ(I)$PWM0(I).. D(I)    =E= D0(I) *(PD(I)/PWM0(I))**(ETAD(I)*0.1);
  print('DEQ(I)$PWM0(I)')
  line = ExprM(vars, m = D0.loc[I]) * ( PD.loc(I) / ExprM(vars, m = PWM0.loc[I]))** ExprM(vars, m = ETAD.loc[I] * 0.1)
...
#  NEQ(K,I).. N(K,I)        =E= N0(K,I)*(R(K,I)/R0(K,I))**(ETAIX(K,I)*0.1);
  print('NEQ(K,I)')
  line = ExprM(vars, m = N0.loc[K,I])*(R.loc(K,I)/ExprM(vars, m = R0.loc[K,I]))**ExprM(vars, m = ETAIX.loc[K,I] * 0.1)
...
#                              *  ((SUM(GI, PIT0(GI,H)* HH0(H))+ SUM(G, TAUH(G,H)*HH0(H)))/(SUM(GI, PIT(GI,H)* HH(H))+ SUM(G, TAUH(G,H)*HH(H))))**(ETAPIT(H));
  ...
  line2 = (((RA.loc(L) / ExprM(vars, m = RA0.loc[L])).sum(L)/24)/(CPI.loc(H) / ExprM(vars, m = CPI0[H]))\
           * (LSEQ1line2pre.sum(0)/((HW.loc(H1) * ExprM(vars, m = JOBCOR.loc[H1,L].sum(1))).sum(H1) + CMO.loc(CM).sum(CM) + CMI.loc(L).sum(L)))\
           + ((ExprM(vars, m = EXWGEO.loc[CM].sum(0))/RA.loc(L)).sum(0)/96)\
           * (CMO.loc(CM).sum(CM)/((HW.loc(H1) * ExprM(vars, m = JOBCOR.loc[H1,L].sum(1))).sum(H1) + CMO.loc(CM).sum(CM) + CMI.loc(L).sum(L))))\
  ...
  line4 =( ((ExprM(vars, m = PIT0.loc[GI,H])* ExprM(vars, m = HH0.loc[H])).sum(GI)+ (ExprM(vars, m = TAUH0.loc[G,H])*ExprM(vars, m = HH0.loc[H])).sum(G))\
...
# LSEQ2A('OUT1').. CMO('OUT1')=E= CMO0('OUT1')* (((EXWGEO('OUT1') /RA('L1WA') ))** ECOMO('OUT1'));
  print('LSEQ2A')
  line = ExprM(vars, m = CMO0.loc[CM1]) * ((ExprM(vars, m = EXWGEO.loc[CM1].sum(0)) / RA.loc(FW1))**(ExprM(vars, m = ECOMO.loc[CM1])))
...
# LSEQ2B('OUT2').. CMO('OUT2')=E= CMO0('OUT2')* (((EXWGEO('OUT2') /RA('L2WA') ))** ECOMO('OUT2'));
  print('LSEQ2B')
  line = ExprM(vars, m = CMO0.loc[CM2]) * ((ExprM(vars, m = EXWGEO.loc[CM2].sum(0)) / RA.loc(FW2))**(ExprM(vars, m = ECOMO.loc[CM2])))
...
# LSEQ2C('OUT3').. CMO('OUT3')=E= CMO0('OUT3')* (((EXWGEO('OUT3') /RA('L3WA') ))** ECOMO('OUT3'));
  print('LSEQ2C')
  line = ExprM(vars, m = CMO0.loc[CM3]) * ((ExprM(vars, m = EXWGEO.loc[CM3].sum(0)) / RA.loc(FW3))**(ExprM(vars, m = ECOMO.loc[CM3])))
...
# LSEQ2D('OUT4').. CMO('OUT4')=E= CMO0('OUT4')* (((EXWGEO('OUT4') /RA('L4WA') ))** ECOMO('OUT4'));
  print('LSEQ2D')
  line = ExprM(vars, m = CMO0.loc[CM4]) * ((ExprM(vars, m = EXWGEO.loc[CM4].sum(0)) / RA.loc(FW4))**(ExprM(vars, m = ECOMO.loc[CM4])))
...
# LSEQ3(L).. CMI(L)  =E= CMI0(L)* ((( RA(L)/(SUM( H, CPI(H))/30))** ECOMI(L)));
  print('LSEQ3')
  line = ExprM(vars, m = CMI0.loc[L]) * ((RA.loc(L) / (CPI.loc(H).sum(H) / 30))**(ExprM(vars, m = ECOMI.loc[L])))
...
#                                         *((HN0(H)/HH0(H))/(HN(H)/HH(H))) ** (ETAU(H))  ;
  ...
  line2 = ExprM(vars, m = MI0.loc[H]) * ((YD.loc(H)/HH.loc(H)) / ExprM(vars, m = YD0.loc[H] / HH0.loc[H]) / (CPI.loc(H)/ExprM(vars, m = CPI0.loc[H]))) ** ExprM(vars, m = ETAYD.loc[H])
  line3 = ((HN.loc(H)   / HH.loc(H)   ) / ExprM(vars, m = HN0.loc[H]  / HH0.loc[H]  ) ) ** ExprM(vars, m = ETAU.loc[H])
  line4 = ExprM(vars, m = MO0.loc[H]) * (ExprM(vars, m = YD0.loc[H]  / HH0.loc[H]  ) / ( YD.loc(H) / HH.loc(H) ) / ( ExprM(vars, m = CPI0.loc[H]) / CPI.loc(H) ) ) ** ExprM(vars, m = ETAYD.loc[H])
